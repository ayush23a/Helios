        ...
        <div className="lg:col-span-7 space-y-6 text-center lg:text-left flex flex-col items-center lg:items-start">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto pt-2">
            ...
            <a
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-7 py-3.5 text-xs font-bold uppercase tracking-wider text-white bg-gradient-to-r from-brand-orange to-brand-gold rounded-full hover:brightness-110 shadow-lg shadow-brand-orange/20 hover:scale-[1.02] active:scale-[0.98] transition-all group"
            >
            ...
            <div className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-6 py-3.5 text-xs font-medium text-zinc-400 bg-white/[0.02] border border-white/[0.08] rounded-full cursor-default">
